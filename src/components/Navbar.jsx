...
const Navbar = () => {
    ...
    return (
        <Box style={{ width: "100%", position:"static", top: "0", marginBottom: "1%" }}>
            <Box style={{ padding: "5px", backgroundColor:"lightgreen", color: "black" }}><Center>
            ...
            <Box style={{ display: "flex", justifyContent: "space-around", alignItems: "center", padding: "5px", backgroundColor: "black", color: "white" }}>
                <Box><Img width={80} height={50} src={logo} /></Box>
            ...
            <Flex style={{
                ...
                , justifyContent: "space-evenly", padding: "1%", backgroundColor: " lightgreen "
            }}>
                <Box style={{ width:"10%",display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <Burger />
                    <Routerlink to={'/'}><img width={100} height={250} src={log} alt='logo' /></Routerlink>
            ...
            <Flex style={{ background: "lightgrey", color: "red", padding: "1%", justifyContent: "space-evenly",textDecorationColor:"black" }} className='Nav'>
